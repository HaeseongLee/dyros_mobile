...
Caster::Caster(double _Kx, double _Ky, double _ang,
               double _b, double _r,
...
: Lambda(M3Z), Mu(V3Z), Ce(M3I), Jdot(M3Z), A(M3Z), CC(V3Z), L_Pk(M3Z), Mu_Pk(V3Z)
{
  Kx = _Kx;   Ky = _Ky;   ang = _ang;
...
void Caster::Fill_LM(double const _u, // sigma dot
